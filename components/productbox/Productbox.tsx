...
export const Productbox = () => {
  return (
    <div className='py-4 xl:py-6 px-5 xl:px-10 flex flex-col border-2 border-solid border-black rounded w-[300px] xl:w-[450px] bg-white'>
      ...
      <p className='text-secondary'>keine versteckten Kosten, kein Baukasten, Pure Kreativität</p>
      ...
      <div className='flex flex-col'>
        <p className='text-secondary'>nur:</p>
        <p className='text-6xl text-center'>900€</p>
        <p className='text-secondary'>exkl. Mwst.</p>
      </div>
